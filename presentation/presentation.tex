...
\begin{frame}{Existing Algorithm: \proc{DirectComp}}
    \begin{tabular}{r l}
        ...
        Query & $O(|\LCE(i,j)|)=O(n)$ \\
        Average query & $O(1)$ \\
        Query I/Os & $O\Big(\frac{|\LCE(i,j)|}{B}\Big)$ \\
    \end{tabular}
...
\begin{frame}{The \fprintk\ Algorithm: I/O}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Size: $|H_\ell| = n$
            \item I/Os: $O\big(k\cdot n^{1/k}\big)$
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item I/Os: $O\Big(k\cdot\Big(\frac{n^{1/k}}{B}+1\Big)\Big)$
            \begin{itemize}
...
\begin{frame}{The \fprintk\ Algorithm}
    \begin{tabular}{r l}
        ...
        Query & $O(k\cdot n^{1/k})$ \\
        Average query & $O(1)$ \\
        Query I/Os & $O\Big(k\cdot\Big(\frac{n^{1/k}}{B}+1\Big)\Big)$ \\
    \end{tabular}
...
%    \end{tabular}
    ...
    \begin{multicols}{2}{
        ...
        \begin{tabular}{r l}
            ...
            Query & $O(\sqrt n)$ \\
            Average query & $O(1)$ \\
            Query I/Os & $O\Big(\frac{\sqrt n}{B}\Big)$ \\
        \end{tabular}
        \newpage
        $k=\logceil$:

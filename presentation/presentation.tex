...
\begin{frame}{The \fprintk\ Algorithm: Practical Results}
    ...
    \begin{multicols}{2}{
        \begin{center}
            Average case
            \includegraphics[width=0.49\textwidth,type=pdf,ext=.pdf,read=.pdf]{../src/results/length-slides-rand10.plt}
            \newpage
            Worst case
            \includegraphics[width=0.49\textwidth,type=pdf,ext=.pdf,read=.pdf]{../src/results/length-slides-alla.plt}
        \end{center}
    }
    \end{multicols}
\end {frame}
...
\begin{frame}{The \fprintk\ Algorithm: Practical Results}
    ...
    \begin{center}
        Medium LCE size\\
        \includegraphics[width=0.49\textwidth,type=pdf,ext=.pdf,read=.pdf]{../src/results/length-slides-repeat-pow.plt}
    \end{center}
\end {frame}
